...
import { ListCardContainer, SocialButtonsContainer } from './list-card.styled';
...
const ListCard: FC<ListCardProps> = ({ title, description, link, image }) => {
  return (
    <ListCardContainer>
      ...
      <SocialButtonsContainer>
        ...
        <button aria-label="Copy waitlist link">
          {link}
          <svg
            aria-hidden
            width="22"
